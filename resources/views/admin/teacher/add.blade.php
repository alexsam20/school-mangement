                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('marital_status') }}" name="marital_status" required placeholder="Enter Marital Status">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea rows="3" class="form-control" name="address" required placeholder="Enter Current Address">{{ old('address') }}</textarea>
                                            <div style="color: red">{{ $errors->first('profile_pic') }}</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="permanent_address">Permanent Address</label>
                                            <textarea rows="3" class="form-control" name="permanent_address" placeholder="Enter Permanent Address">{{ old('permanent_address') }}</textarea>
                                            <div style="color: red">{{ $errors->first('address') }}</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="qualification">Qualification</label>
                                            <textarea rows="3" class="form-control" name="qualification" placeholder="Enter Qualification">{{ old('qualification') }}</textarea>
                                            <div style="color: red">{{ $errors->first('qualification') }}</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="work_experience">Work Experience</label>
                                            <textarea rows="3" class="form-control" name="work_experience" placeholder="Enter Work Experience">{{ old('work_experience') }}</textarea>
                                            <div style="color: red">{{ $errors->first('work_experience') }}</div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="note">Note</label>
                                            <textarea rows="3" class="form-control" name="note" placeholder="Enter Note">{{ old('note') }}</textarea>
