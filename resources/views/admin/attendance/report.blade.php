                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" name="student_id" placeholder="Student ID" value="{{ request('student_id') }}">
                                        </div>

                                        <div class="form-group col-md-2">
                                            <label for="name">Student Name</label>
                                            <input type="text" class="form-control" name="student_name" placeholder="Student Name" value="{{ request('student_name') }}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control" name="attendance_type">
                                                ...
                                                <option {{(request('attendance_type') == 1) ? 'selected' : ''}} value="1">Present</option>
                                                <option {{(request('attendance_type') == 2) ? 'selected' : ''}} value="2">Late</option>
                                                <option {{(request('attendance_type') == 3) ? 'selected' : ''}} value="3">Absent</option>
                                                <option {{(request('attendance_type') == 4) ? 'selected' : ''}} value="4">Half Day</option>
                                            </select>
                                        </div>
